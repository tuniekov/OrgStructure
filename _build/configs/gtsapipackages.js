    ...
    orgstructure:{
        ...
        gtsAPITables:{
            osTree:{
                ...
                version:17, // при изменении в файле надо обновлять версию, чтобы изменения применились при установке.
                ...
                properties: { // свойства таблицы
                    query:{
                        // Сортировка узлов: сначала всё кроме сотрудников
                        // (osOrg, osFilial, osDepartment, ...), потом osEmployee.
                        // Внутри группы — по menuindex, при равенстве — по id.
                        sortby:{
                            "(osTree.class = 'osEmployee')":'ASC',
                            "osTree.menuindex":'ASC',
                            "osTree.id":'ASC',
                        },
                    },
